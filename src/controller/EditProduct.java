...
@WebServlet("/gentelella-master/production/EditProduct")
public class EditProduct extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			rs = new ConnectToDatabase().selectData("select * from ProductGuitar where stt='" + stt + "'");
			while (rs.next()) {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			new ConnectToDatabase().excuteSql("update ProductGuitar set stt='" + stt + "',maSanPham='" + maSanPham
