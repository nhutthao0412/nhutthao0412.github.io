...
@WebServlet("/gentelella-master/production/EditCategoryUkulele")
public class EditCategoryUkulele extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			rs = new ConnectToDatabase().selectData("select * from CategoryUkulele where maDanhMuc='" + maDanhMuc + "'");
			while (rs.next()) {
			...
			response.sendRedirect("editCategoryUkulele.jsp");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			new ConnectToDatabase().excuteSql("update CategoryUkulele set maDanhMuc='" + maDanhMuc + "',tenLoaiGuitar='"
