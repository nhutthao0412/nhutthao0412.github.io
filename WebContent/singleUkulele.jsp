...
<body>
	...
	ProductGuitar productGuitar = sanphamDAO.getChiTietSanPhamUkulele(request.getParameter("maSanPham"));
	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			...
			<div class="w3_agile_latest_arrivals">
				...
				ResultSet rs = con.selectData("SELECT TOP 50 PERCENT * FROM ProductUkulele ORDER BY NEWID()");
				while (rs.next()) {
				%>
						...
						<div class="men-thumb-item">
							...
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="singleUkulele.jsp?maSanPham=<%=rs.getString(2)%>"
