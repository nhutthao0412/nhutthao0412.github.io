...
<head>
<meta charset="UTF-8">
<title>Chỉnh sửa TT danh mục Guitar</title>
<link rel="stylesheet"
		...
		<div class="row">
			...
			<div class="col-md-9 personal-info">
				...
				<form class="form-horizontal" role="form"
					action="EditCategoryGuitar" method="post">
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<select class="form-control" name="danhMucCha">
								<option value="6">Loại Đàn</option>
								<option value="7">Thương Hiệu</option>
								<option value="8">Khoảng Giá</option>
							</select>
						</div>
					</div>
